...
The capstone merge test, all through tRPC callers + `immediateDispatcher` + fakes (TextGenerator canned parse, fake ImageGenerator, in-memory storage, real test DB):
