...
import { useStoryParse } from "./useStoryParse"
...
describe("useStoryParse", () => {
  ...
  it("moves from idle through parsing to done as the task polls", () => {
    const { result, rerender } = renderHook(() => useStoryParse("s1"))
