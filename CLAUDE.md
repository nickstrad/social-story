...
2. `/judge-branch` — judges the full worktree diff (committed and uncommitted) against the plan directly in the session and writes `JUDGEMENT.md` at the worktree root.
